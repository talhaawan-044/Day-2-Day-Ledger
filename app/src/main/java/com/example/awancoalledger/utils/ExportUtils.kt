...
object ExportUtils {
        ...
        try {
            ...
            val intent =
                    Intent(Intent.ACTION_SEND).apply {
                        ...
                        putExtra(Intent.EXTRA_SUBJECT, "Day 2 Day Ledger Backup")
    ...
    fun generateAndShareExcel(
        ...
        try {
            ...
            val bytes = XlsxWriter.create(
                title    = "Generated by: Day 2 Day Ledger",
                subtitle = partyLine,
                headers  = headers,
                dataRows = dataRows,
                summary  = summary
    ...
    fun shareDetailedEntry(context: Context, entry: LedgerEntry, partyName: String) {
        ...
        val text =
            ...
            -----------------------------------
            *Generated by: Day 2 Day Ledger*
        """.trimIndent()
        shareText(context, text, "com.whatsapp")
    }

    fun shareDetailedPayment(context: Context, payment: Payment, partyName: String) {
        val df = SimpleDateFormat("EEEE, MMMM dd, yyyy", Locale.getDefault())
